							...
							<tbody>
								...
								<tr>
									...
									<td>
										{result.method === 'standard'
											? `t = ${
													// biome-ignore lint/style/noNonNullAssertion: 如果是标准回归，t 一定存在
													markS(result.m.b1t!, result.m.b1p)
												}`
											: `F = ${
													// biome-ignore lint/style/noNonNullAssertion: 如果是序列回归，F 一定存在
													markS(result.m.b1F!, result.m.b1p)
												}`}
									</td>
									<td>
										{result.method === 'standard'
								...
								<tr>
									...
									<td>
										{result.method === 'standard'
											? `t = ${
													// biome-ignore lint/style/noNonNullAssertion: 如果是标准回归，t 一定存在
													markS(result.m.b2t!, result.m.b2p)
												}`
											: `F = ${
													// biome-ignore lint/style/noNonNullAssertion: 如果是序列回归，F 一定存在
													markS(result.m.b2F!, result.m.b2p)
												}`}
									</td>
									<td>
										{result.method === 'standard'
