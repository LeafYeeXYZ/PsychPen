  ...
  return (
    <div className='component-main variable-view'>
        ...
        >
          ...
          >
            <Select
              ...
              onChange={(value) => setShowDiscretize(value.includes('discretize'))}
            />
          </Form.Item>
          {showDiscretize && (
      ...
      <div className='component-result variable-view'>
        ...
        <p className='intro-text'>离散化是指把数据转换为分类数据, 分为等宽、等频和聚类分析 <Tag>k-means</Tag> 三种方法</p>
        <p className='intro-text'>进行这些操作时, <b>PsychPen 不会改变原始数据, 而是生成新的子变量</b></p>
      </div>
